...
document.querySelectorAll(".nav-tab").forEach(function(tab) {
  tab.addEventListener("click", function() {
    ...
    ["sorting", "divisaohc"].forEach(function(p) {
      document.getElementById("page-" + p).style.display = (p === tab.dataset.page) ? "" : "none";
    });
  });
});
...
document.querySelectorAll(".chip-cycle").forEach(function(chip) {
  chip.addEventListener("click", function() {
    document.querySelectorAll(".chip-cycle").forEach(function(c) { c.classList.remove("active"); });
